...
(* OASIS_START *)
(* DO NOT EDIT (digest: 62ca5e077a9e93d984118704f62d1575) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Disk_unix"; "Disk_dummy"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lvm";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "O.S\001\197\210\012;\208M\200\n\1930\145\247";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
