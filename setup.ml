...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a8762ee37424b3fa8597abd565daf19) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./tag_test.native", []))];
          ...
          ("vg_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./vg_test.native", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("allocator_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./allocator_test.native", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the device-mapper interface";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Disk_mirage"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lvm";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "lvm";
                           InternalLibrary "lvm_mirage";
                           InternalLibrary "lvm_dummy";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "tag_test.ml"});
               Test
                 ({
                     cs_name = "tag_test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "vg_test.ml"});
               Test
                 ({
                     cs_name = "vg_test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "allocator_test.ml"});
               Test
                 ({
                     cs_name = "allocator_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\250\225&|s\007rz\165\0073=\015\252\014\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
