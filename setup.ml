...
(* OASIS_START *)
(* DO NOT EDIT (digest: f723143a44a720b196863f986bfd78c8) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Lvmconfiglex"; "Lvmconfigparser"; "Absty"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\185\252\018\212\253\251s\024l{\199\224\167_?\169";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
